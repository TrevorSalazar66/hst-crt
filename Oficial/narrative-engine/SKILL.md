...
description: Protocolo mestre de geração e co-criação de histórias usando Oráculos Python, Estado Dinâmico em JSON, Metodologias de Cena e Modos Narrativos.
---
